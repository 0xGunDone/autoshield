...
- Публичные страницы: `/`, `/services`, `/services/[slug]`, `/pricing`, `/contacts`
...
- Форма записи:
  ...
  - вопросы: марка/модель/год, запуск кнопка/ключ, гарантия, функции, демонтаж старой системы, выбран вариант или нужна консультация, контакты
  - сохранение в SQLite

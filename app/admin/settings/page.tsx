      ...
      >
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <div>
            ...
            <input
              name="request_email"
              type="email"
              defaultValue={settings.request_email}
              required
            />
          </div>
          <div>
          ...
          <div>
            ...
            <input
              name="work_hours"
              defaultValue={settings.work_hours}
              required
            />
          </div>
        </div>
        ...
        <div>
          ...
          <textarea
            name="map_iframe"
            rows={5}
            defaultValue={settings.map_iframe}
          />
        </div>
        ...
        <div>
          ...
          <input
            name="metrika_id"
            defaultValue={settings.metrika_id}
        ...
        <p className="text-sm text-slate-300">
          Плейсхолдеры: {"{id}"}, {"{name}"}, {"{phone}"}, {"{car_brand}"},{" "}
          {"{car_model}"}, {"{car_year}"}, {"{features}"}, {"{center_name}"}
        </p>
        <div>
        ...
        <div>
          ...
          <textarea
            ...
            rows={3}
            defaultValue={settings.telegram_template}
          />
        </div>
        <div>
          ...
          <textarea
            name="call_template"
            rows={4}
            defaultValue={settings.call_template}
          />
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <div>
            ...
            <input
              ...
              min={0}
              max={1}
              defaultValue={settings.smtp_secure}
              required
            />
          </div>
          <div>
        ...
        {searchParams?.saved ? (
          <p className="text-sm text-emerald-200">Изменения сохранены.</p>
        ) : null}
        {searchParams?.error ? (
          <p className="text-sm text-rose-300">
            Ошибка сохранения: {searchParams.error}
          </p>
        ) : null}
      </form>
    </AdminShell>

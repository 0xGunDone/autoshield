      ...
      >
        ...
        <div>
          ...
          <input
            ...
            defaultValue={content.hero_button_text}
            required
          />
        </div>
        ...
        <div>
          <label className="mb-1 block text-sm">
            Преимущества (JSON-массив строк)
          </label>
          <textarea
            name="advantages_json"
            rows={5}
            defaultValue={content.advantages_json}
            required
          />
        </div>
        ...
        <div>
          <label className="mb-1 block text-sm">
            FAQ (JSON-массив объектов {"{question, answer}"})
          </label>
          <textarea
            name="faq_json"
            rows={8}
            defaultValue={content.faq_json}
            required
          />
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <div>
            ...
            <input
              name="home_seo_title"
              defaultValue={content.home_seo_title}
              required
            />
          </div>
          <div>
            <label className="mb-1 block text-sm">
              SEO description главной
            </label>
            <input
              name="home_seo_description"
              defaultValue={content.home_seo_description}
              required
            />
          </div>
        </div>
